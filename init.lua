...
require('lazy').setup({
  ...
  -- Use the `dependencies` key to specify the dependencies of a particular plugin
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ss', builtin.quickfix, { desc = '[S]earch [Q]uick Fix' })
      vim.keymap.set('n', '<leader>sw', builtin.grep_cword, { desc = '[S]earch current [W]ord' })
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep' })
      vim.keymap.set('n', '<leader>sd', builtin.diagnostics_document, { desc = '[S]earch [D]iagnostics Documents' })
      vim.keymap.set('n', '<leader>sg', builtin.diagnostics_document, { desc = '[S]earch Dia[g]nostics Workspace' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grt', require('fzf-lua').lsp_definitions, '[G]oto [T]ype Definition')
